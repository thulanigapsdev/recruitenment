      ...
      <div class="single-hero-items set-bg" data-setbg="assets/img/hero-1.jpg">
          <div class="container">
              <div class="row">
                  <div class="col-lg-5">
                      <span>Coaching</span>
                      <h1>Entrepreneurship Mentoring</h1>
              ...
              <div class="off-card">
                  <h2>Recruitment<span>Specialist</span></h2>
              </div>
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-lg-4">
              <div class="single-banner">
                  <img src="assets/img/banner-11.jpeg" alt="" />
          ...
          <div class="col-lg-4">
              <div class="single-banner">
                  <img src="assets/img/banner-22.jpeg" alt="" />
                  <div class="inner-text">
                      <h4>Bootcamp</h4>
                  </div>
              </div>
...
-->
<section class="deal-of-week set-bg spad" data-setbg="assets/img/courses.jpg">
  <div class="container">
          ...
          <div class="col-lg-4 col-md-6">
              <div class="single-latest-blog">
                  ...
                  <div class="latest-text">
                      ...
                      <a href="#">
                          <h4>HIGH PERFORMANCE ENTREPRENEUR</h4>
                      </a>
          ...
          <div class="col-lg-4 col-md-6">
              <div class="single-latest-blog">
                  ...
                  <div class="latest-text">
                      ...
                      <a href="#">
                          <h4>90-DAY ACCELERATOR (0 > $10K/Month)</h4>
                      </a>
                      <p>Sed quia non numquam modi tempora indunt ut labore et dolore magnam aliquam quaerat </p>
                  </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6">
              <div class="single-latest-blog">
                  ...
                  <div class="latest-text">
                      ...
                      <a href="#">
                          <h4>INNER CIRCLE - NEXT LEVEL ($10K/mo > $30K/mo)</h4>
                      </a>
                      <p>Sed quia non numquam modi tempora indunt ut labore et dolore magnam aliquam quaerat </p>
                  </div>
              </div>
